# treatments.py
# ─────────────────────────────────────────────────────────────────
# Single source of truth for all treatment types and durations.
#
# Slot tiers:
...
TREATMENT_CATALOGUE: list[Treatment] = [
    ...
    # SHORT – 20 min
    Treatment("dental_checkup",     "Dental Checkup",         20, "SHORT"),
    Treatment("tooth_pain",         "Tooth Pain Consultation", 20, "SHORT"),
    Treatment("braces_alignment",   "Braces / Alignment",     20, "SHORT"),

    # MEDIUM – 30 min
    Treatment("cosmetic_dental",    "Cosmetic Dental",        30, "MEDIUM"),
    Treatment("gum_treatment",      "Gum Treatment",          30, "MEDIUM"),
    Treatment("missing_tooth",      "Missing Tooth Replacement", 30, "MEDIUM"),
    Treatment("tooth_extraction",   "Tooth Extraction / Removal", 30, "MEDIUM"),
    Treatment("cavity_filling",     "Cavity Filling",         30, "MEDIUM"),

    # LONG – 45 min
    Treatment("root_canal",         "Root Canal Treatment",   45, "LONG"),
]
...
def list_treatments_for_display() -> str:
    """
    Returns a numbered list of all treatments for chatbot display.
    Groups by slot tier.
    """
    lines = []
    current_tier = None
    tier_labels = {"SHORT": "Quick visit (20 min)", "MEDIUM": "Standard (30 min)", "LONG": "Extended (45 min)"}
